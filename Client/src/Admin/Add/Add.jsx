...
const Add = () => {
  ...
  return (
    <div className='w-full min-h-screen flex'>
      <Navbar />
      <div className='w-4/5 min-h-screen px-4 py-8 flex justify-center items-center'>
        <div className='w-1/2 relative'>
          <h1 className='text-2xl text-center font-semibold mb-4'>Add Student</h1>
          {
            message ? <span className='absolute top-8 left-1/2 -translate-x-1/2'>{message}</span> : <></>
          }
